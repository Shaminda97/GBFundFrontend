...
public class FundAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String output = fundObj.insertFund(request.getParameter("reasearcherID"), 
				 request.getParameter("reasearchTopic"), 
				request.getParameter("fundersID"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 ...
		 paras.get("reasearcherID").toString(), 
		 paras.get("reasearchTopic").toString(), 
		paras.get("fundersID").toString(), 
